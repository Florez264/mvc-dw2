    ...
    function authenticate(){
        if( $this->existPOST(['username', 'password']) ){
            ...
            if($username == '' || empty($username) || $password == '' || empty($password)){
                ...
                $this->redirect('', ['error' => ErrorMenssages::ERROR_LOGIN_AUTHENTICATE_EMPTY]);
                return;
            }
            ...
            if($user != NULL){
                ...
                $this->redirect('', ['error' => ErrorMenssages::ERROR_LOGIN_AUTHENTICATE_DATA]);
                return;
            }
        }else{
            ...
            $this->redirect('', ['error' => ErrorMenssages::ERROR_LOGIN_AUTHENTICATE]);
        }
    }
}
